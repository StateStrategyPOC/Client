...
public class RequestForceEndTurnSidePolicy implements SidePolicy {
    ...
    public void apply(ClientState state, StoreAction action) {
        ...
        RRNotification clientNotification = new RRNotification(true,"You have taken too much to act, you will skip your turn",null,null,null,null,null,null);
        CLIENT_STORE.propagateAction(new ClientSetCurrentRRNotificationAction(clientNotification));
